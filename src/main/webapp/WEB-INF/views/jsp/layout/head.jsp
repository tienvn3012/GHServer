...
<spring:url value="/resources/css/lib/dataTables.bootstrap.min.css" var="bootstrap_dataTable_css"></spring:url>
...
<spring:url value="/resources/js/lib/jquery.dataTables.min.js" var="jquery_dataTable"></spring:url>
...
<spring:url value="/resources/js/lib/dataTables.bootstrap.min.js" var="bootstrap_dataTable_js"></spring:url>
...
<link href="${bootstrap_dataTable_css}" type="text/css" rel="stylesheet" />
...
<script src="${jquery_dataTable}"></script>
<script src="${bootstrapjs}"></script>
<script src="${bootstrap_toggle_js}"></script>
<script src="${bootstrap_dataTable_js}"></script>
